...
5 套基于瑞士国际主义风格（Swiss Style）的高反差配色。**每套都遵循"高级灰白底 + 单一高饱和高亮色"的极简原则**——这是瑞士风的灵魂,不允许混搭多个高亮色。
...
**适合**：UPerform（优普丰）品牌内训、敏捷/Scrum 认证课程、企业内部分享。
**调性**：深海蓝 + 珊瑚橙,专业、温暖、有活力,商务与培训场景兼顾。
...
--grey-3:#083A67;
--accent:#FF9B7D;
--accent-rgb:255,155,125;
--accent-on:#041C32;
```

**品牌三色速查**:Primary `#083A67` | Secondary `#4F82BA` | Accent `#FF9B7D`

**使用要点**：
- 深海蓝沉稳专业,珊瑚橙活力温暖,两者形成冷暖对比但不冲突
- 适合"敏捷转型"、"团队协作"、"领导力"等培训主题
- 珊瑚橙色块上用深海蓝字,对比清晰可读性强
